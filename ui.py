...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.brushHardSoft = QtWidgets.QPushButton(self.sidebar)
        self.brushHardSoft.setGeometry(QtCore.QRect(20, 280, 61, 41))
        self.brushHardSoft.setObjectName("brushHardSoft")
        self.brushStyleLabel = QtWidgets.QLabel(self.sidebar)
        self.brushStyleLabel.setGeometry(QtCore.QRect(20, 250, 101, 16))
        self.brushStyleLabel.setObjectName("brushStyleLabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.brushHardSoft.setText(_translate("MainWindow", "Hard"))
        self.brushStyleLabel.setText(_translate("MainWindow", "Current brush style:"))
